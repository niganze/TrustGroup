  ...
  const blogPosts = [
    {
      ...
      excerpt:
        "Exploring innovative building techniques and materials that are shaping the future of sustainable construction across East Africa.",
      category: "insights",
    ...
    },
    {
      ...
      excerpt:
        "A comprehensive guide to the most important factors that every investor should consider before venturing into the real estate market.",
      category: "tips",
    ...
    },
    {
      ...
      excerpt:
        "Celebrating the successful completion of the Busanza Apartments project, featuring 84 modern dwelling units across six building blocks.",
      category: "news",
    ...
    },
    {
      ...
      excerpt:
        "An examination of how mixed-use developments are creating more vibrant, walkable, and sustainable urban communities.",
      category: "insights",
    ...
    },
    {
      ...
      excerpt:
        "How our development projects go beyond buildings to create lasting positive impacts on communities and social cohesion.",
      category: "insights",
    ...
    },
    {
      id: 6,
      title:
        "Optimizing Construction Timelines: Best Practices for Project Management",
      excerpt:
        "Expert tips on how to keep construction projects on schedule and within budget through effective project management techniques.",
      category: "tips",
    ...
    },
    {
      id: 7,
      title:
        "Real Estate Valuation: Understanding Property Worth in Changing Markets",
      excerpt:
        "A comprehensive guide to understanding how properties are valued and what factors influence their worth in dynamic market conditions.",
      category: "tips",
    ...
    },
    {
      ...
      excerpt:
        "Exciting announcement of our latest mixed-use development project featuring commercial spaces, offices, and residential apartments.",
      category: "news",
      ...
      <div className="container mx-auto px-6 md:px-8 lg:px-12 max-w-7xl">
        <div className="text-center mb-16 bg-[#00A3D9] py-12 px-4 rounded-lg">
          ...
          <p className="text-white max-w-2xl mx-auto">
            Stay updated with the latest news, industry insights, and expert
            advice from Trusty Group.
          </p>
        </div>
          ...
          <div className="mb-20">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
                ...
                <div className="md:flex">
                  ...
                  <div className="p-8 md:p-10 md:w-1/2 flex flex-col justify-center">
                    <div className="uppercase tracking-wide text-sm text-[#00A3D9] font-semibold mb-2">
                      {featuredPosts[0]?.category === "news"
                        ? "Latest News"
                        : featuredPosts[0]?.category === "insights"
                        ? "Insights & Articles"
                        : "Tips & Resources"}
                    </div>
              ...
              {featuredPosts.slice(1, 3).map((post) => (
                <div
                  key={post.id}
                  className="bg-white rounded-xl shadow-md overflow-hidden transform transition-all duration-300 hover:translate-y-[-5px] hover:shadow-lg"
                >
                  ...
                  <div className="p-8">
                    <h4 className="text-xl font-bold text-gray-900 mb-3 line-clamp-2 font-heading">
                      {post.title}
                    </h4>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          {filteredPosts.map((post) => (
            ...
            >
              ...
              <div className="p-6">
                <h4 className="text-xl font-bold text-gray-900 mb-3 line-clamp-2 hover:text-[#00A3D9] transition-colors font-heading">
                  {post.title}
                </h4>
                ...
                <div className="flex flex-wrap gap-2 mb-5">
                  {post.tags.map((tag) => (
                    <span
                      key={tag}
                      className="text-xs text-gray-500 bg-gray-100 px-3 py-1 rounded-full hover:bg-gray-200 transition-colors cursor-pointer"
                    >
                      #{tag}
                    </span>
                  ))}
          ...
          <div className="bg-gradient-to-r from-[#00A3D9] to-blue-600 p-10 text-white text-center relative">
            ...
            <div className="relative z-10 max-w-2xl mx-auto">
              ...
              <p className="mb-8 text-blue-50">
                Stay up-to-date with the latest insights, news, and tips from
                Trusty Group. We'll send you valuable content directly to your
                inbox.
              </p>
